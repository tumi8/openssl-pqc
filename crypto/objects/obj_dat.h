...
/* Serialized OID's */
static const unsigned char so[7979] = {
    ...
    0x2B,0xCE,0x0F,0x06,0x01,0x04,                 /* [ 7900] OBJ_sphincsharaka128fsimple */
    0x2B,0xCE,0x0F,0x06,0x01,0x05,                 /* [ 7906] OBJ_p256_sphincsharaka128fsimple */
    0x2B,0xCE,0x0F,0x06,0x01,0x06,                 /* [ 7912] OBJ_rsa3072_sphincsharaka128fsimple */
    0x2B,0xCE,0x0F,0x06,0x02,0x03,                 /* [ 7918] OBJ_sphincsharaka192fsimple */
    0x2B,0xCE,0x0F,0x06,0x02,0x04,                 /* [ 7924] OBJ_p384_sphincsharaka192fsimple */
    0x2B,0xCE,0x0F,0x06,0x03,0x03,                 /* [ 7930] OBJ_sphincsharaka256fsimple */
    0x2B,0xCE,0x0F,0x06,0x03,0x04,                 /* [ 7936] OBJ_p521_sphincsharaka256fsimple */
    0x2B,0xCE,0x0F,0x06,0x04,0x01,                 /* [ 7942] OBJ_sphincssha256128frobust */
    0x2B,0xCE,0x0F,0x06,0x04,0x02,                 /* [ 7948] OBJ_p256_sphincssha256128frobust */
    0x2B,0xCE,0x0F,0x06,0x04,0x03,                 /* [ 7954] OBJ_rsa3072_sphincssha256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x01,                 /* [ 7960] OBJ_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x02,                 /* [ 7966] OBJ_p256_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x03,                 /* [ 7972] OBJ_rsa3072_sphincsshake256128frobust */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"ClassicMcEliece348864", "ClassicMcEliece348864", NID_ClassicMcEliece348864},
    {"ClassicMcEliece8192128", "ClassicMcEliece8192128", NID_ClassicMcEliece8192128},
    { NULL, NULL, NID_undef },
    ...
    {"p256_ClassicMcEliece348864", "p256_ClassicMcEliece348864", NID_p256_ClassicMcEliece348864},
    {"p521_ClassicMcEliece8192128", "p521_ClassicMcEliece8192128", NID_p521_ClassicMcEliece8192128},
    ...
    {"sphincsharaka128fsimple", "sphincsharaka128fsimple", NID_sphincsharaka128fsimple, 6, &so[7900]},
    {"p256_sphincsharaka128fsimple", "p256_sphincsharaka128fsimple", NID_p256_sphincsharaka128fsimple, 6, &so[7906]},
    {"rsa3072_sphincsharaka128fsimple", "rsa3072_sphincsharaka128fsimple", NID_rsa3072_sphincsharaka128fsimple, 6, &so[7912]},
    {"sphincsharaka192fsimple", "sphincsharaka192fsimple", NID_sphincsharaka192fsimple, 6, &so[7918]},
    {"p384_sphincsharaka192fsimple", "p384_sphincsharaka192fsimple", NID_p384_sphincsharaka192fsimple, 6, &so[7924]},
    {"sphincsharaka256fsimple", "sphincsharaka256fsimple", NID_sphincsharaka256fsimple, 6, &so[7930]},
    {"p521_sphincsharaka256fsimple", "p521_sphincsharaka256fsimple", NID_p521_sphincsharaka256fsimple, 6, &so[7936]},
    {"sphincssha256128frobust", "sphincssha256128frobust", NID_sphincssha256128frobust, 6, &so[7942]},
    {"p256_sphincssha256128frobust", "p256_sphincssha256128frobust", NID_p256_sphincssha256128frobust, 6, &so[7948]},
    {"rsa3072_sphincssha256128frobust", "rsa3072_sphincssha256128frobust", NID_rsa3072_sphincssha256128frobust, 6, &so[7954]},
    {"sphincsshake256128frobust", "sphincsshake256128frobust", NID_sphincsshake256128frobust, 6, &so[7960]},
    {"p256_sphincsshake256128frobust", "p256_sphincsshake256128frobust", NID_p256_sphincsshake256128frobust, 6, &so[7966]},
    {"rsa3072_sphincsshake256128frobust", "rsa3072_sphincsshake256128frobust", NID_rsa3072_sphincsshake256128frobust, 6, &so[7972]},
};
...
static const unsigned int sn_objs[NUM_SN] = {
    ...
    1219,    /* "ClassicMcEliece348864" */
    1220,    /* "ClassicMcEliece8192128" */
     367,    /* "CrlID" */
     391,    /* "DC" */
      31,    /* "DES-CBC" */
     643,    /* "DES-CDMF" */
    ...
    1141,    /* "oscca" */
     475,    /* "otherMailbox" */
     876,    /* "owner" */
    1245,    /* "p256_ClassicMcEliece348864" */
    1237,    /* "p256_bikel1" */
    1248,    /* "p256_dilithium2" */
    1255,    /* "p256_dilithium2_aes" */
    1262,    /* "p256_falcon512" */
    1222,    /* "p256_frodo640aes" */
    1223,    /* "p256_frodo640shake" */
    1242,    /* "p256_hqc128" */
    1228,    /* "p256_kyber512" */
    1239,    /* "p256_kyber90s512" */
    1231,    /* "p256_ntru_hps2048509" */
    1267,    /* "p256_sphincsharaka128fsimple" */
    1274,    /* "p256_sphincssha256128frobust" */
    1277,    /* "p256_sphincsshake256128frobust" */
    1238,    /* "p384_bikel3" */
    1251,    /* "p384_dilithium3" */
    1258,    /* "p384_dilithium3_aes" */
    1224,    /* "p384_frodo976aes" */
    1225,    /* "p384_frodo976shake" */
    1243,    /* "p384_hqc192" */
    1229,    /* "p384_kyber768" */
    1240,    /* "p384_kyber90s768" */
    1232,    /* "p384_ntru_hps2048677" */
    1235,    /* "p384_ntru_hrss701" */
    1270,    /* "p384_sphincsharaka192fsimple" */
    1246,    /* "p521_ClassicMcEliece8192128" */
    1253,    /* "p521_dilithium5" */
    1260,    /* "p521_dilithium5_aes" */
    1265,    /* "p521_falcon1024" */
    1226,    /* "p521_frodo1344aes" */
    1227,    /* "p521_frodo1344shake" */
    1244,    /* "p521_hqc256" */
    1230,    /* "p521_kyber1024" */
    1241,    /* "p521_kyber90s1024" */
    1234,    /* "p521_ntru_hps40961229" */
    1233,    /* "p521_ntru_hps4096821" */
    1236,    /* "p521_ntru_hrss1373" */
    1272,    /* "p521_sphincsharaka256fsimple" */
    ...
    1033,    /* "pkInitKDC" */
     ...
     448,    /* "room" */
     463,    /* "roomNumber" */
    1249,    /* "rsa3072_dilithium2" */
    1256,    /* "rsa3072_dilithium2_aes" */
    1263,    /* "rsa3072_falcon512" */
    1268,    /* "rsa3072_sphincsharaka128fsimple" */
    1275,    /* "rsa3072_sphincssha256128frobust" */
    1278,    /* "rsa3072_sphincsshake256128frobust" */
       6,    /* "rsaEncryption" */
    ...
    1142,    /* "sm-scheme" */
     387,    /* "snmpv2" */
    1266,    /* "sphincsharaka128fsimple" */
    1269,    /* "sphincsharaka192fsimple" */
    1271,    /* "sphincsharaka256fsimple" */
    1273,    /* "sphincssha256128frobust" */
    1276,    /* "sphincsshake256128frobust" */
     660,    /* "street" */
      85,    /* "subjectAltName" */
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1261,    /* OBJ_falcon512                    1 3 9999 3 1 */
    1262,    /* OBJ_p256_falcon512               1 3 9999 3 2 */
    1263,    /* OBJ_rsa3072_falcon512            1 3 9999 3 3 */
    1264,    /* OBJ_falcon1024                   1 3 9999 3 4 */
    1265,    /* OBJ_p521_falcon1024              1 3 9999 3 5 */
    ...
    1248,    /* OBJ_p256_dilithium2              1 3 9999 2 7 1 */
    1249,    /* OBJ_rsa3072_dilithium2           1 3 9999 2 7 2 */
    1251,    /* OBJ_p384_dilithium3              1 3 9999 2 7 3 */
    1253,    /* OBJ_p521_dilithium5              1 3 9999 2 7 4 */
    1255,    /* OBJ_p256_dilithium2_aes          1 3 9999 2 11 1 */
    1256,    /* OBJ_rsa3072_dilithium2_aes       1 3 9999 2 11 2 */
    1258,    /* OBJ_p384_dilithium3_aes          1 3 9999 2 11 3 */
    1260,    /* OBJ_p521_dilithium5_aes          1 3 9999 2 11 4 */
    1266,    /* OBJ_sphincsharaka128fsimple      1 3 9999 6 1 4 */
    1267,    /* OBJ_p256_sphincsharaka128fsimple 1 3 9999 6 1 5 */
    1268,    /* OBJ_rsa3072_sphincsharaka128fsimple 1 3 9999 6 1 6 */
    1269,    /* OBJ_sphincsharaka192fsimple      1 3 9999 6 2 3 */
    1270,    /* OBJ_p384_sphincsharaka192fsimple 1 3 9999 6 2 4 */
    1271,    /* OBJ_sphincsharaka256fsimple      1 3 9999 6 3 3 */
    1272,    /* OBJ_p521_sphincsharaka256fsimple 1 3 9999 6 3 4 */
    1273,    /* OBJ_sphincssha256128frobust      1 3 9999 6 4 1 */
    1274,    /* OBJ_p256_sphincssha256128frobust 1 3 9999 6 4 2 */
    1275,    /* OBJ_rsa3072_sphincssha256128frobust 1 3 9999 6 4 3 */
    1276,    /* OBJ_sphincsshake256128frobust    1 3 9999 6 7 1 */
    1277,    /* OBJ_p256_sphincsshake256128frobust 1 3 9999 6 7 2 */
    1278,    /* OBJ_rsa3072_sphincsshake256128frobust 1 3 9999 6 7 3 */
    ...
    1247,    /* OBJ_dilithium2                   1 3 6 1 4 1 2 267 7 4 4 */
    1250,    /* OBJ_dilithium3                   1 3 6 1 4 1 2 267 7 6 5 */
    1252,    /* OBJ_dilithium5                   1 3 6 1 4 1 2 267 7 8 7 */
    1254,    /* OBJ_dilithium2_aes               1 3 6 1 4 1 2 267 11 4 4 */
    1257,    /* OBJ_dilithium3_aes               1 3 6 1 4 1 2 267 11 6 5 */
    1259,    /* OBJ_dilithium5_aes               1 3 6 1 4 1 2 267 11 8 7 */
