...
///// OQS_TEMPLATE_FRAGMENT_LIST_SIG_SWITCH_CASES_START
    ...
    case EVP_PKEY_P256_SPHINCSHARAKA128SROBUST:
    case EVP_PKEY_RSA3072_SPHINCSHARAKA128SROBUST:
    case EVP_PKEY_SPHINCSHARAKA128SSIMPLE:
    case EVP_PKEY_P256_SPHINCSHARAKA128SSIMPLE:
    case EVP_PKEY_RSA3072_SPHINCSHARAKA128SSIMPLE:
    case EVP_PKEY_SPHINCSHARAKA192FROBUST:
    case EVP_PKEY_P384_SPHINCSHARAKA192FROBUST:
    case EVP_PKEY_SPHINCSHARAKA192FSIMPLE:
    case EVP_PKEY_P384_SPHINCSHARAKA192FSIMPLE:
    case EVP_PKEY_SPHINCSHARAKA192SROBUST:
    case EVP_PKEY_P384_SPHINCSHARAKA192SROBUST:
    case EVP_PKEY_SPHINCSHARAKA192SSIMPLE:
    case EVP_PKEY_P384_SPHINCSHARAKA192SSIMPLE:
    case EVP_PKEY_SPHINCSHARAKA256FROBUST:
    case EVP_PKEY_P521_SPHINCSHARAKA256FROBUST:
    case EVP_PKEY_SPHINCSHARAKA256FSIMPLE:
    case EVP_PKEY_P521_SPHINCSHARAKA256FSIMPLE:
    case EVP_PKEY_SPHINCSHARAKA256SROBUST:
    case EVP_PKEY_P521_SPHINCSHARAKA256SROBUST:
    case EVP_PKEY_SPHINCSHARAKA256SSIMPLE:
    case EVP_PKEY_P521_SPHINCSHARAKA256SSIMPLE:
    ...
    case EVP_PKEY_P256_SPHINCSSHA256128FSIMPLE:
    case EVP_PKEY_RSA3072_SPHINCSSHA256128FSIMPLE:
    case EVP_PKEY_SPHINCSSHA256128SROBUST:
    case EVP_PKEY_P256_SPHINCSSHA256128SROBUST:
    case EVP_PKEY_RSA3072_SPHINCSSHA256128SROBUST:
    case EVP_PKEY_SPHINCSSHA256128SSIMPLE:
    case EVP_PKEY_P256_SPHINCSSHA256128SSIMPLE:
    case EVP_PKEY_RSA3072_SPHINCSSHA256128SSIMPLE:
    case EVP_PKEY_SPHINCSSHA256192FROBUST:
    case EVP_PKEY_P384_SPHINCSSHA256192FROBUST:
    case EVP_PKEY_SPHINCSSHA256192FSIMPLE:
    case EVP_PKEY_P384_SPHINCSSHA256192FSIMPLE:
    case EVP_PKEY_SPHINCSSHA256192SROBUST:
    case EVP_PKEY_P384_SPHINCSSHA256192SROBUST:
    case EVP_PKEY_SPHINCSSHA256192SSIMPLE:
    case EVP_PKEY_P384_SPHINCSSHA256192SSIMPLE:
    case EVP_PKEY_SPHINCSSHA256256FROBUST:
    case EVP_PKEY_P521_SPHINCSSHA256256FROBUST:
    case EVP_PKEY_SPHINCSSHA256256FSIMPLE:
    case EVP_PKEY_P521_SPHINCSSHA256256FSIMPLE:
    case EVP_PKEY_SPHINCSSHA256256SROBUST:
    case EVP_PKEY_P521_SPHINCSSHA256256SROBUST:
    case EVP_PKEY_SPHINCSSHA256256SSIMPLE:
    case EVP_PKEY_P521_SPHINCSSHA256256SSIMPLE:
    ...
    case EVP_PKEY_P256_SPHINCSSHAKE256128SROBUST:
    case EVP_PKEY_RSA3072_SPHINCSSHAKE256128SROBUST:
    ...
    case EVP_PKEY_P384_SPHINCSSHAKE256192FROBUST:
    ...
    case EVP_PKEY_P384_SPHINCSSHAKE256192SROBUST:
    ...
    case EVP_PKEY_P521_SPHINCSSHAKE256256FROBUST:
    ...
    case EVP_PKEY_P521_SPHINCSSHAKE256256SROBUST:
