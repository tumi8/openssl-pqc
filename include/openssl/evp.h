...
#define OQS_OPENSSL_SIG_algs_length 32
#define OQS_OPENSSL_KEM_algs_length 25
#define IS_OQS_OPENSSL_KEM_NID(a) ((a >= 0x01FF) && (a <= NID_p521_Classic-McEliece-8192128))
