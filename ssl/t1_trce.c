...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_OQS_frodo640shake), "frodo640shake"},
    {OQS_KEM_CURVEID(NID_OQS_frodo976aes), "frodo976aes"},
    {OQS_KEM_CURVEID(NID_OQS_frodo976shake), "frodo976shake"},
    {OQS_KEM_CURVEID(NID_OQS_frodo1344aes), "frodo1344aes"},
    {OQS_KEM_CURVEID(NID_OQS_frodo1344shake), "frodo1344shake"},
    {OQS_KEM_CURVEID(NID_OQS_bike1l1cpa), "bike1l1cpa"},
    {OQS_KEM_CURVEID(NID_OQS_bike1l3cpa), "bike1l3cpa"},
    {OQS_KEM_CURVEID(NID_OQS_bike1l1fo), "bike1l1fo"},
    {OQS_KEM_CURVEID(NID_OQS_bike1l3fo), "bike1l3fo"},
    {OQS_KEM_CURVEID(NID_OQS_kyber512_90s), "kyber512_90s"},
    {OQS_KEM_CURVEID(NID_OQS_kyber768_90s), "kyber768_90s"},
    {OQS_KEM_CURVEID(NID_OQS_kyber1024_90s), "kyber1024_90s"},
    {OQS_KEM_CURVEID(NID_OQS_newhope512cca), "newhope512cca"},
    {OQS_KEM_CURVEID(NID_OQS_newhope1024cca), "newhope1024cca"},
    {OQS_KEM_CURVEID(NID_OQS_ntru_hps2048509), "ntru_hps2048509"},
    {OQS_KEM_CURVEID(NID_OQS_ntru_hps2048677), "ntru_hps2048677"},
    {OQS_KEM_CURVEID(NID_OQS_ntru_hps4096821), "ntru_hps4096821"},
    {OQS_KEM_CURVEID(NID_OQS_ntru_hrss701), "ntru_hrss701"},
    {OQS_KEM_CURVEID(NID_OQS_lightsaber), "lightsaber"},
    {OQS_KEM_CURVEID(NID_OQS_saber), "saber"},
    {OQS_KEM_CURVEID(NID_OQS_firesaber), "firesaber"},
    {OQS_KEM_CURVEID(NID_OQS_sidhp434), "sidhp434"},
    {OQS_KEM_CURVEID(NID_OQS_sidhp503), "sidhp503"},
    {OQS_KEM_CURVEID(NID_OQS_sidhp610), "sidhp610"},
    {OQS_KEM_CURVEID(NID_OQS_sidhp751), "sidhp751"},
    {OQS_KEM_CURVEID(NID_OQS_sikep434), "sikep434"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_OQS_p256_frodo640shake), "p256 - frodo640shake hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_frodo976aes), "p256 - frodo976aes hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_frodo976shake), "p256 - frodo976shake hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_frodo1344aes), "p256 - frodo1344aes hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_frodo1344shake), "p256 - frodo1344shake hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike1l1cpa), "p256 - bike1l1cpa hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike1l3cpa), "p256 - bike1l3cpa hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike1l1fo), "p256 - bike1l1fo hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_bike1l3fo), "p256 - bike1l3fo hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_kyber512_90s), "p256 - kyber512_90s hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_kyber768_90s), "p256 - kyber768_90s hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_kyber1024_90s), "p256 - kyber1024_90s hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_newhope512cca), "p256 - newhope512cca hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_newhope1024cca), "p256 - newhope1024cca hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_ntru_hps2048509), "p256 - ntru_hps2048509 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_ntru_hps2048677), "p256 - ntru_hps2048677 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_ntru_hps4096821), "p256 - ntru_hps4096821 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_ntru_hrss701), "p256 - ntru_hrss701 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_lightsaber), "p256 - lightsaber hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_saber), "p256 - saber hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_firesaber), "p256 - firesaber hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_sidhp434), "p256 - sidhp434 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_sidhp503), "p256 - sidhp503 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_sidhp610), "p256 - sidhp610 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_sidhp751), "p256 - sidhp751 hybrid"},
    {OQS_KEM_CURVEID(NID_OQS_p256_sikep434), "p256 - sikep434 hybrid"},
